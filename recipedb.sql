...
--
-- Host: localhost:8889
-- Generation Time: Apr 15, 2026 at 04:09 PM
...
(2, 2, 1, 'Bananapancake', 'Soft and healthy banana pancakes made with simple ingredients. Perfect for kids and super easy to prepare.', 'banana-pancakes.png', 'banana.mp4'),
(3, 3, 3, 'FruitYogurtcups', 'A healthy and refreshing breakfast made with creamy yogurt and fresh mixed fruits. Perfect for kids to start their day with a nutritious and energy boosting meal.', 'yogurt.png', 'yogurt.mp4'),
(5, 2, 1, 'veggie Omelette', 'A delicious and nutritious breakfast omelette made with eggs, vegetables, and cheese. A great way to give kids a balanced meal full of protein and essential nutrients.', 'omelette.png', 'omelette.mp4'),
(6, 6, 2, 'Chicken & Rise', 'a delicious chicken and rice made with tender chicken and flavorful rice. This healthy and balanced meal is perfect for kids, providing protein and energy to start the day', 'chicken-rice.png', 'chicken-rice.png.mp4');
