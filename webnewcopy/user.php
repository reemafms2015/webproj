...
if (!empty($user['photoFileName']) && file_exists(__DIR__ . "/images/users/" . $user['photoFileName'])) {
    ...
    $userPhotoPath = "images/users/profile.png";
}
...
categorySelect.addEventListener("change", function () {
    ...
    fetch("filterRecipes.php?categoryID=" + categoryID)
    ...
    .then(function(data) {
            ...
            data.forEach(function(recipe) {
                ...
                tableContent += `
                    <tr>
                        ...
                        <td>
                            <img src="${recipe.photoFileName}" 
                                 class="recipeImg"
                                 alt="Recipe Photo">
                        </td>

                        <td>
                            <img src="${recipe.creatorPhoto}" 
                                 class="creatorImg"
                                 alt="Creator Photo">
                            <br>
                            ${recipe.creatorName}
        ...
        document.getElementById("recipesTable").innerHTML = tableContent;
